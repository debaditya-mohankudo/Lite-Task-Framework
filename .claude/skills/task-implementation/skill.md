...
[/task-verification](../task-verification/skill.md) is a standalone pass, not a step this skill gates on — it activates and deactivates its own task, and can be run whenever, independent of finishing.
